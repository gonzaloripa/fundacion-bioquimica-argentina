<br>
  <h3 >.Llene el formulario para dar de alta un nuevo laboratorio</h3>
<br>
<form name="altalab" action="altaLaboratorio.php" method="post">
<p>Codigo de laboratorio: <input name='codigo' type='text' value="{{ laboratorio.codigo }}"    /> </p>
...
<p> <input name="altaenvio" type="submit" value="Enviar"  />  <input name="borrartodo" type="button" value="Borrar Todo" onClick="document.getElementsByName('altalab')[0].reset();" />
</form>